...
| Target build | POC2 (`poc2/`) — Stage A done; B01 Camera next |
...
**Next steps:** 1) TDD writes failing tests for `SDD-B01` Camera; 2) Programming implements until green; 3) then C01 Ship → C02 Controller for Fase 0 motion.
