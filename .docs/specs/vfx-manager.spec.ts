 ...
 *            request freeze frames), score popups (G10/G07).
 ...
 *   SDD-A01 Balancer — BALANCE.vfx.shake.maxAmplitude 0.18, hitStopFrames 3
...
// ─── 9. Agent sign-off ───────────────────────────────────────────────────────
/**
 * Orchestrator : hub-v4.1 / 2026-08-17  scope, requires, DoD, Q11 split
 * Programming  : hub-v4.1 / 2026-08-17  pooled bursts, A04 freeze, shakeOffset port
 * Game Design  : hub-v4.1 / 2026-08-17  cap 0.18, hitStop 3, readability
 ...
 *            shield tick is a sparkle not a quake. Mega+wave must stay readable
 ...
 * Runner: vitest
 * Mocks: HitStopPort, burst ObjectPool, vignette HTMLElement, BALANCE.vfx,
 ...
 *
 * Coverage: R1–R11 + RUL-13 + Q11 + card Acceptance.
 */
